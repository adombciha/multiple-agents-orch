...
DEFAULT_CONFIG = {
    ...
    "role_models": {
        ...
        "developer_junior": "deepseek-r1:latest",
        "qa_senior": "deepseek-r1:latest",
        "qa_middle": "qwen2.5-coder:14b",
        "qa_junior": "gemma4:latest",
        "assistant": "gemma4:latest",
        "architect": "deepseek-r1:latest",
        "ra": "grok-4.5",
        ...
        "fae": "qwen3:8b",
        "integration": "deepseek-r1:latest",
        "sales": "grok-4.5",
        "sre": "gemini-3.1-pro"
    },
    "role_model_backends": {
    ...
    "role_model_routes": {
        ...
        "integration": [["ollama", "deepseek-r1:latest"], ["ollama", "qwen2.5-coder:14b"], ["ollama", "deepseek-coder-v2:latest"]],
